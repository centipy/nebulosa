...
class CustomerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Obtener clientes, aplicando filtro si hay búsqueda
        $customers = Customer::query()
            ...
            ->orderBy('full_name') // Ordenar por nombre completo por defecto
            ->paginate(10); // Paginación de 10 clientes por página

        return Inertia::render('Customers/Index', [
            'customers' => $customers,
            'filters' => $request->only(['search']), // Pasar los filtros actuales a la vista
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $validatedData = $request->validate([
            ...
            // Añade validación para los demás campos según sea necesario
        ]);
