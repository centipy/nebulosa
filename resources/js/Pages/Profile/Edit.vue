...
// Asegurarse de que los campos nulos se inicialicen correctamente
const form = useForm({
    ...
    telemarketing_observations: props.customer.telemarketing_observations || '',
    advisor_observations: props.customer.advisor_observations || '',
});

const submit = () => {
    form.put(route('customers.update', props.customer.id), {
        // Esta opción mejora la experiencia al volver a la lista
        preserveScroll: true,
    });
};
</script>
